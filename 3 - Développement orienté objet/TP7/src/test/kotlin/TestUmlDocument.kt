...
import kotlin.reflect.KVisibility
	...
	/***** Generated JUnit/UMLChecker Test Cases for Document *****/
...
class TestUmlDocument {
	...
	fun `test7 - 'Document' has an attribute 'feuilles'`() {
		uml.attributeCheck("feuilles", Array<Feuille?>::class)
	}
	...
	fun `test10 - 'Document' has a method 'nouvelleFeuille'`() {
		uml.methodCheck("nouvelleFeuille", Boolean::class, methParamAndTypes=arrayOf(Pair("hauteur", Int::class), Pair("largeur", Int::class)))
	}
